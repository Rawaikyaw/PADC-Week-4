package com.dev.hmm.hostmyanmar;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Intent ourServices = new Intent(MainActivity.this,Services.class);
            startActivity(ourServices);
        } else if (id == R.id.contact_us) {
            Intent contactUs = new Intent(MainActivity.this,ContactUs.class);
            startActivity(contactUs);
        }else if (id == R.id.our_products) {
            Intent ourProducts = new Intent(MainActivity.this,OurProducts.class);
            startActivity(ourProducts);
        }
